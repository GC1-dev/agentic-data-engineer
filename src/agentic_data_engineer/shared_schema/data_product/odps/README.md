...
# [customer example](https://github.com/bitol-io/open-data-product-standard/blob/main/docs/examples/customer-data-product.odps.yaml)
...
```json
    {
      ...
      "versions": {
        ...
        ...
        "v0.9.0": "https://github.com/bitol-io/open-data-product-standard/blob/main/schema/odps-json-schema-v1.0.0.json"
      }
    },
```

And the `odps-json-schema-latest.json` should be updated with the latest version changes.
